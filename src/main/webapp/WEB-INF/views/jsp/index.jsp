	...
	<div id="wrapper">
		...
		<ul
			...
			<a
				...
				href="index">
				<div class="sidebar-brand-icon rotate-n-n">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				href="customer-list" data-toggle="collapse"
				data-target="#collapseTwo" aria-expanded="true"
				aria-controls="collapseTwo"> <i class="fas fa-fw fa-cog"></i> <span>Customer
						Management</span>
			</a></li>
			<li class="nav-item"><a class="nav-link collapsed"
				href="customer-list" data-toggle="collapse"
				data-target="#collapseTwo" aria-expanded="true"
				aria-controls="collapseTwo"> <i class="fas fa-fw fa-cog"></i> <span>Reservation
						Management</span>
			</a></li>
			<li class="nav-item"><a class="nav-link collapsed"
				href="customer-list" data-toggle="collapse"
				data-target="#collapseTwo" aria-expanded="true"
				aria-controls="collapseTwo"> <i class="fas fa-fw fa-cog"></i> <span>Reception
						Management</span>
			</a></li>
